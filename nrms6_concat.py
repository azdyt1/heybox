...
class TitleLayer(nn.Module):
    def __init__(self, num_words, embeddings_matrix, args):
        ...
        self.mediallayer = args.medialayer // 2
...
class Nrms(nn.Module):
    ...
    def forward(self, candidate_news, clicked_news, click_len, labels=None):
        ...
        user_embed = self.userencoder([clicked_news, click_len])
...
def parse_args():
    ...
    parser.add_argument('-wd', '--word_embed_size', help='Embedding Size', type=int, default=40)
    parser.add_argument('-cd', '--categ_embed_size', help='Embedding Size', type=int, default=10)
    parser.add_argument('-ad', '--author_embed_size', help='Embedding Size', type=int, default=10)
    ...
    parser.add_argument('--head_size', type=int, default=20)
    ...
    parser.add_argument('--medialayer', type=int, default=50)
...
class MyDataset():
    def __init__(self, args):
        ...
        news_file = np.load('news_info_4.2.npz', allow_pickle=True)
        ...
        train_test_data = np.load('train_test_data_4.2_n5.npz', allow_pickle=True)
        ...
        #     pos = temp[-1]
        #     temp = temp[:-1]
        #     temp = random.sample(temp, min(2, len(temp)))
